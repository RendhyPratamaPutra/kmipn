            ...
            <nav class="navbar header-navbar pcoded-header">
               <div class="navbar-wrapper">
                   <div class="navbar-logo">
                       ...
                       <a href="index.html">
                           <img class="img-fluid" src="<?php echo base_url(''); ?>vendor/assets/images/logo.png" alt="Theme-Logo" />
                       </a>
                       ...
                       <ul class="nav-right">
                           <li class="header-notification">
                               ...
                               <ul class="show-notification">
                                   ...
                                   <li>
                                       <div class="media">
                                           <img class="d-flex align-self-center img-radius" src="<?php echo base_url(''); ?>vendor/assets/images/avatar-2.jpg" alt="Generic placeholder image">
                                   ...
                                   <li>
                                       <div class="media">
                                           <img class="d-flex align-self-center img-radius" src="<?php echo base_url(''); ?>vendor/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                                           <div class="media-body">
                                   ...
                                   <li>
                                       <div class="media">
                                           <img class="d-flex align-self-center img-radius" src="<?php echo base_url(''); ?>vendor/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                                           <div class="media-body">
                           ...
                           <li class="user-profile header-notification">
                               <a href="#!">
                                   <img src="<?php echo base_url(''); ?>vendor/assets/images/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
                                   <span>John Doe</span>
                                                            ...
                                                            <div class="tab-pane active" id="home3" role="tabpanel">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table">
                                                                        ...
                                                                        <tr>
                                                                            <td><img src="<?php echo base_url(''); ?>vendor/assets/images/product/prod2.jpg" alt="prod img" class="img-fluid"></td>
                                                                            <td>PNG002344</td>
                                                                            <td>John Deo</td>
                                                                            <td>05-01-2017</td>
                                                                        ...
                                                                        <tr>
                                                                            <td><img src="<?php echo base_url(''); ?>vendor/assets/images/product/prod3.jpg" alt="prod img" class="img-fluid"></td>
                                                                            <td>PNG002653</td>
                                                                            <td>Eugine Turner</td>
                                                                            <td>04-01-2017</td>
                                                                        ...
                                                                        <tr>
                                                                            <td><img src="<?php echo base_url(''); ?>vendor/assets/images/product/prod4.jpg" alt="prod img" class="img-fluid"></td>
                                                                            <td>PNG002156</td>
                                                            ...
                                                            <div class="tab-pane" id="messages3" role="tabpanel">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table">
                                                                        ...
                                                                        <tr>
                                                                            <td><img src="<?php echo base_url(''); ?>vendor/assets/images/product/prod1.jpg" alt="prod img" class="img-fluid"></td>
                                                                            <td>PNG002413</td>
                                                                            <td>Jane Elliott</td>
                                                                            <td>06-01-2017</td>
                                                        ...
                                                        <ul class="feed-blog">
                                                            <li class="active-feed">
                                                                <div class="feed-user-img">
                                                                    <img src="<?php echo base_url(''); ?>vendor/assets/images/avatar-3.jpg" class="img-radius " alt="User-Profile-Image">
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-auto text-center">
                                                                        <img src="<?php echo base_url(''); ?>vendor/assets/images/blog/blog-r-1.jpg" alt="img" class="img-fluid img-100">
                                                                        <h6 class="m-t-15 m-b-0">Old Scooter</h6>
                                                                        <p class="text-muted m-b-0"><small>PNG-100KB</small></p>
                                                                    </div>
                                                                    <div class="col-auto text-center">
                                                                        <img src="<?php echo base_url(''); ?>vendor/assets/images/blog/blog-r-2.jpg" alt="img" class="img-fluid img-100">
                                                                        <h6 class="m-t-15 m-b-0">Wall Art</h6>
                                                                        <p class="text-muted m-b-0"><small>PNG-150KB</small></p>
                                                                    </div>
                                                                    <div class="col-auto text-center">
                                                                        <img src="<?php echo base_url(''); ?>vendor/assets/images/blog/blog-r-3.jpg" alt="img" class="img-fluid img-100">
...
<!-- am chart -->
<script src="<?php echo base_url(''); ?>vendor/assets/pages/widget/amchart/amcharts.min.js"></script>
<script src="<?php echo base_url(''); ?>vendor/assets/pages/widget/amchart/serial.min.js"></script>
<!-- Chart js -->
<script type="text/javascript" src="<?php echo base_url(''); ?>vendor/assets/js/chart.js/Chart.js"></script>
<!-- Todo js -->
<script type="text/javascript " src="<?php echo base_url(''); ?>vendor/assets/pages/todo/todo.js "></script>
<!-- Custom js -->
<script type="text/javascript" src="<?php echo base_url(''); ?>vendor/assets/pages/dashboard/custom-dashboard.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(''); ?>vendor/assets/js/script.js"></script>
<script type="text/javascript " src="<?php echo base_url(''); ?>vendor/assets/js/SmoothScroll.js"></script>

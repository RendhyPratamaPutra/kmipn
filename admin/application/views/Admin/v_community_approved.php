												...
												<div class="table-responsive">
													<table class="table">
														...
														<tbody>
															<?php
															$no = 1;
															foreach ($community_approved as $users) : ?>
																<tr>
																	<th><?= $no++ ?></th>
																	...
																	<td style="text-align:center" width="200px">
																		<?php
																			echo anchor(site_url('Admin/status_community_approved/' . $users['id_community']), 'Banned Community', 'onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
																			?>
																	</td>
																</tr>
															<?php endforeach ?>

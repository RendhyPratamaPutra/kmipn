												...
												<div class="card">
													...
													<div class="card-block">
														...
														<div class="form-group row">
															...
															<div class="col-sm-10">
																<textarea rows="5" cols="5" type="text" name="description" class="form-control" placeholder="deskripsikan event anda"></textarea>
															</div>
														</div>
														<div class="form-group row">
															<label class="col-sm-2 col-form-label">Lokasi Event</label>
															<div class="col-sm-10">
																<input type="text" id="pac-input" name="address" class="form-control" placeholder="masukkan lokasi">

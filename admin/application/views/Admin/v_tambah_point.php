											...
											<div class="col-sm-12">
												...
												<div class="card">
													...
													<div class="card-block">
														...
														<div class="form-group row">
															<div class="col-sm-3">
																<input type="number" name="sampah_plastik" class="form-control" placeholder="berat sampah (gr)">
															</div>
															<div class="col-sm-1">
                                                        ...
                                                        <div class="form-group row">
															...
															<div class="col-sm-3">
																<input type="number" name="sampah_logam" class="form-control" placeholder="berat sampah (gr)">
															</div>
															<div class="col-sm-1">
                                                        ...
                                                        <div class="form-group row">
															...
															<div class="col-sm-3">
																<input type="number" name="sampah_lain" class="form-control" placeholder="berat sampah (gr)">
															</div>
															<div class="col-sm-1">
																<input type="number" name="" class="form-control" readonly>
															</div>

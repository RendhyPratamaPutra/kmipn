...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Sep 2019 pada 17.38
...
(22, 6, 2, 'Ainun Najib', '1', '1', 1, 1500, '2019-08-28');
...
(2, 'Topi Bersihnesia', '', 1500, 12, 'barang');
...
(1, 'Rendhy', 'Bondowoso', '082335854884', 'rendhypratama880@gmail.com', '@2019', 'Lak-laki', '2019-08-29', '', 1500, 1),
...
(6, 'Ainun Najib', '1', '1', '1', '1', 'Laki-laki', '0000-00-00', 0x494d475f32303139303831365f3135313133362e6a7067, 4000, 2),
...
(12, 'Rendhy', 'Jember', '082313427729', 'E41172249@student.polije.ac.id', '99999', 'Lak-laki', '2019-08-29', '', 0, 2),
(13, 'Rendhy', 'Jember', '082313427729', 'E41172249@student.polije.ac.id', '99999', 'Lak-laki', '2019-08-29', '', 0, 2);
...
(19, 6, 0x494d475f32303139303832383136343234382e6a7067, 'Jl. Mastrip Gg. VII No.9A, Krajan Barat, Sumbersari, Kec. Sumbersari, Kabupaten Jember, Jawa Timur 68121, Indonesia ', '-8.163762499999997,113.72561328124996', 'Rendhy Pego', '0000-00-00', 'Belum Diseleksi');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`u7698500_gagas`@`localhost` SQL SECURITY DEFINER VIEW `jumlah_community`  AS  select count(`community`.`id_community`) AS `jumlah` from `community` ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`u7698500_gagas`@`localhost` SQL SECURITY DEFINER VIEW `jumlah_event`  AS  select count(`tb_event`.`id_event`) AS `jumlah` from `tb_event` ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`u7698500_gagas`@`localhost` SQL SECURITY DEFINER VIEW `jumlah_personal`  AS  select count(`personal`.`id_personal`) AS `jumlah` from `personal` where (not((`personal`.`role_id` like '1'))) ;
...
--
ALTER TABLE `report`
  MODIFY `id_report` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
